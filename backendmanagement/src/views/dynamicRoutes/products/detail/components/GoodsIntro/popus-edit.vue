<template>
	<div class="goods-intro-dialog-container">
		<el-dialog title="商品介绍" v-model="dialog.isShowDialog">
				...
				<el-row :gutter="20">
					...
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="类型" prop="type">
							<el-select v-model="dialog.ruleForm.type" placeholder="请选择类型">
...
const dialog = reactive({
	...
	submitTxt: '确认',
	rules: {
		idx: [{ required: true, message: '请输入排序', trigger: 'change' }],
...
const openDialog = (row: any) => {
	...
	dialog.title = row.id ? '编辑商品介绍' : '新增商品介绍';
