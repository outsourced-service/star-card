<template>
	<view class="uv-avatar" :class="[`uv-avatar--${shape}`]" :style="[{
		...
		}, $uv.addStyle(customStyle)]" @tap="clickHandler">
		<slot>
			...
			<!-- #endif -->
			<uv-icon v-else-if="icon" :name="icon" :size="fontSize" :color="color"></uv-icon>
			<uv-text v-else-if="text" :text="text" :size="fontSize" :color="color" align="center"
				customStyle="justify-content: center"></uv-text>
			<image class="uv-avatar__image" v-else :class="[`uv-avatar__image--${shape}`]"
