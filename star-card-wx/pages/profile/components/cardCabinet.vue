<template>
  <view class="custom-card"  >
    <uni-card spacing="30rpx 24rpx 20rpx 24rpx" padding="12rpx 8rpx" margin="0" :border="false" shadow="0rpx 8rpx 40rpx 0rpx rgba(0, 0, 0, 0.05)">
      <template v-slot:title>
        <view class="custom-top">
          <view class="custom-title-top">
            我的卡柜
            <view class="custom-new" v-if="number">
              +{{number}}
            </view>
          </view>
      ...
      <view class="horizontal-list">
        <view class="list-container">
			<cardModeOne v-for="(item, index) in data" :key="index" :data="item" class="list-container-item" :is_group="true"></cardModeOne>
        </view>
      </view>
    </uni-card>
  </view>
